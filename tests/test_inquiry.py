...
class AtaInformation(TestCase):
 ...
 28     2020 2020 2020 2020 2020 2020 2020 8010                          ..
        ...
        self.assertEquals(obj.identify_device.firmware_revision, 'GH2ZB390')
        self.assertEquals(obj.identify_device.serial_number, '      TF1500Y9HRAM5B')
        self.assertEquals(obj.identify_device.model_number, 'HITACHI HTS725050A7E630')
