...
class TestRelease6Command(TestCase):
    def test_generate_command(self):
        ...
        obj = Release6Command()
        self.assertEqual(obj.pack(), b"\x17\x00\x00\x00\x00\x00")
...
class TestRelease10Command(TestCase):
    def test_generate_command_no_thirdparty(self):
        ...
        self.assertEqual(obj.pack(), b"\x57\x00\x00\x00\x00\x00\x00\x00\x00\x00")
    ...
    def test_generate_command_short_thirdparty(self):
        ...
        self.assertEqual(obj.pack(), b"\x57\x10\x00\x77\x00\x00\x00\x00\x00\x00")
    ...
    def test_generate_command_long_thirdparty(self):
        ...
        self.assertEqual(obj.pack(), b"\x57\x12\x00\x00\x00\x00\x00\x00\x08\x00")
